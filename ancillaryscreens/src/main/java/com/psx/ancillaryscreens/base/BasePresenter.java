...
public class BasePresenter<V extends MvpView, I extends MvpInteractor> implements MvpPresenter<V, I> {
    ...
    /**
     * These dependencies are provided by the {@link com.psx.ancillaryscreens.di.modules.CommonsActivityModule} and
     * {@link com.psx.ancillaryscreens.di.modules.CommonsActivityAbstractProviders} and are required by the Presenter
     ...
     * @param apiHelper           - It is the {@link com.psx.ancillaryscreens.data.network.BackendCallHelperImpl} singleton instance
