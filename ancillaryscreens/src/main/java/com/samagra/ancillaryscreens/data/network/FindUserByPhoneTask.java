...
import com.samagra.ancillaryscreens.data.network.model.UserInformation;
import com.samagra.ancillaryscreens.screens.passReset.OnUserFound;
...
//                "}";
        String json = "{\n" +
                "    \"search\": {\n" +
                "        \"queryString\": \"(registrations.applicationId: a664a16a-95dd-41fc-9b9b-e45fb49cf128)AND(data.phone:" + phoneNo +
                ")\",\n" +
                "        \"sortFields\": [],\n" +
                "        \"numberOfResults\": 10,\n" +
                "        \"startRow\": 0\n" +
