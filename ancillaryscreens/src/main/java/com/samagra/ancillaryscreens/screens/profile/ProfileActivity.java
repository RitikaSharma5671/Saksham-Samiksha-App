...
public class ProfileActivity extends BaseActivity implements ProfileContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button fab_edit_password = findViewById(R.id.fab_edit_password);
        fab_edit_password.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void onProfileEditButtonClicked() {
        ...
        if (profilePresenter.isNetworkConnected()) {
            ...
            if (isInEditMode) {
                ...
                fv.setImageResource(R.drawable.ic_save_icon_color_24dp);
            } else {
                FloatingActionButton fv1 = findViewById(R.id.fab);
                fv1.setImageResource(R.drawable.ic_edit_icon_color_24dp);
            }
            for (ProfileElementHolder elementHolder : dynamicHolders) {
                elementHolder.toggleHolderEnable(isInEditMode);
            }
        } else {
            FloatingActionButton fv11 = findViewById(R.id.fab);
            fv11.setImageResource(R.drawable.ic_edit_icon_color_24dp);
