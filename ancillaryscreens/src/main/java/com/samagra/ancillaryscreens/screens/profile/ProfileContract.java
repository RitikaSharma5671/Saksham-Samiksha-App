...
public interface ProfileContract {
    interface View extends MvpView {
        ...
        void onProfileEditButtonClicked();

        void onEditPasswordButtonClicked();

        void showLoading(String message);

        void hideLoading();

        void onSuccessDone(InstitutionInfo institutionInfo);

        void onErrorUpdateSchoolData();
    }
    ...
    interface Presenter<V extends View, I extends Interactor> extends MvpPresenter<V, I> {
         ...
         * call to get the User's current details from remote using {@link com.samagra.ancillaryscreens.data.network.BackendCallHelper} and then
        ...
        InstitutionInfo fetchSchoolDetails();
    }
}
