...
public class AppConstants {
    ...
    public static final String UPDATE_PASSWORD_URL = "https://relay2.saksham.staging.samagra.io/ams/";
    public static final String SENDER_EMAIL_ID = "";
    public static final String RECEIVER_EMAIL_ID = "";
    public static final String APPLICATION_ID = "15feac9d-2912-4b1f-9d63-32b0123a5006";
