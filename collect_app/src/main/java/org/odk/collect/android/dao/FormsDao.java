...
public class FormsDao {
    ...
    public Cursor getFormsCursor(String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        return Collect1.getInstance().getAppContext().getContentResolver().query(FormsColumns.CONTENT_URI, projection, selection, selectionArgs, sortOrder);
    }

    public Cursor getFormsCursor(Uri uri) {
        return Collect1.getInstance().getAppContext().getContentResolver().query(uri, null, null, null, null);
    }
    ...
    private CursorLoader getFormsCursorLoader(String selection, String[] selectionArgs, String sortOrder, boolean newestByFormId) {
        ...
        return new CursorLoader(Collect1.getInstance().getAppContext(), formUri, null, selection, selectionArgs, sortOrder);
    }
    ...
    public void deleteFormsDatabase() {
        Collect1.getInstance().getAppContext().getContentResolver().delete(FormsColumns.CONTENT_URI, null, null);
    }
    ...
    public void deleteFormsFromIDs(String[] idsToDelete) {
        ...
        Collect1.getInstance().getAppContext().getContentResolver().delete(FormsColumns.CONTENT_URI, selection.toString(), idsToDelete);
    }

    public Uri saveForm(ContentValues values) {
        return Collect1.getInstance().getAppContext().getContentResolver().insert(FormsColumns.CONTENT_URI, values);
    }
    ...
    public int updateForm(ContentValues values, String where, String[] whereArgs) {
        return Collect1.getInstance().getAppContext().getContentResolver().update(FormsColumns.CONTENT_URI, values, where, whereArgs);
    }
