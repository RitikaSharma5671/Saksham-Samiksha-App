...
public class FormsDao {
    ...
    public Cursor getFormsCursor(String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        return Collect.getInstance().getApplication().getContentResolver().query(FormsColumns.CONTENT_URI, projection, selection, selectionArgs, sortOrder);
    }

    public Cursor getFormsCursor(Uri uri) {
        return Collect.getInstance().getApplication().getContentResolver().query(uri, null, null, null, null);
    }
    ...
    private CursorLoader getFormsCursorLoader(String selection, String[] selectionArgs, String sortOrder, boolean newestByFormId) {
        ...
        return new CursorLoader(Collect.getInstance().getApplicationContext(), formUri, null, selection, selectionArgs, sortOrder);
    }
    ...
    public void deleteFormsDatabase() {
        Collect.getInstance().getApplication().getContentResolver().delete(FormsColumns.CONTENT_URI, null, null);
    }
    ...
    public void deleteFormsFromIDs(String[] idsToDelete) {
        ...
        Collect.getInstance().getApplication().getContentResolver().delete(FormsColumns.CONTENT_URI, selection.toString(), idsToDelete);
    }

    public Uri saveForm(ContentValues values) {
        return Collect.getInstance().getApplication().getContentResolver().insert(FormsColumns.CONTENT_URI, values);
    }
    ...
    public int updateForm(ContentValues values, String where, String[] whereArgs) {
        return Collect.getInstance().getApplication().getContentResolver().update(FormsColumns.CONTENT_URI, values, where, whereArgs);
    }
