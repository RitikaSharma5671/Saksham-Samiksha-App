...
public class AudioVideoImageTextLabel extends RelativeLayout implements View.OnClickListener {
    ...
    public AudioVideoImageTextLabel(Context context) {
        super(context);
        View view = View.inflate(context, R.layout.audio_video_image_text_label, this);
        audioButton = view.findViewById(R.id.audioButton);
        videoButton = view.findViewById(R.id.videoButton);
        imageView = view.findViewById(R.id.imageView);
        missingImage = view.findViewById(R.id.missingImage);
        textContainer = view.findViewById(R.id.text_container);
        labelTextView = view.findViewById(R.id.text_label);
        mediaButtonsContainer = view.findViewById(R.id.media_buttons);
    }
