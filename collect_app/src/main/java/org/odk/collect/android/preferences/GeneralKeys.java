...
public final class GeneralKeys {
    ...
    private static HashMap<String, Object> getHashMap() {
        ...
        // odk_server_preferences.xmll
        hashMap.put(KEY_SERVER_URL,                 Collect.getInstance().getApplicationContext().getResources().getString(R.string.default_server_url));
        ...
        hashMap.put(KEY_FORMLIST_URL,               Collect.getInstance().getApplicationContext().getResources().getString(R.string.default_odk_formlist));
        hashMap.put(KEY_SUBMISSION_URL,             Collect.getInstance().getApplicationContext().getResources().getString(R.string.default_odk_submission));
        // server_preferences.xml
        hashMap.put(KEY_PROTOCOL,                   Collect.getInstance().getApplicationContext().getResources().getString(R.string.protocol_odk_default));
        // user_interface_preferences.xml
        hashMap.put(KEY_APP_THEME,                  Collect.getInstance().getApplicationContext().getResources().getString(R.string.app_theme_light));
        ...
        hashMap.put(KEY_SPLASH_PATH,                Collect.getInstance().getApplicationContext().getResources().getString(R.string.default_splash_path));
