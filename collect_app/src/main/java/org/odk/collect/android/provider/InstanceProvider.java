...
public class InstanceProvider extends ContentProvider {
    ...
    private void deleteAllFilesInDirectory(File directory) {
        if (directory.exists()) {
            ...
            // media attachments.
            if (directory.isDirectory() && !Collect1.isODKTablesInstanceDataDirectory(directory)) {
            ...
            switch (URI_MATCHER.match(uri)) {
                ...
                case INSTANCE_ID:
                    ...
                    if (status != null && status.equals(Instance.STATUS_SUBMITTED)) {
                        ...
                        count = Collect1.getInstance().getAppContext().getContentResolver().update(uri, cv, null, null);
                    } else {
                        String[] newWhereArgs;
