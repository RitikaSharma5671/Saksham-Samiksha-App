        ...
        for (ServerFormDetails serverFormDetails : values[0]) {
            try {
                ...
                formDownloader.downloadForm(serverFormDetails, count -> {
                    String message = Collect.getInstance().getApplicationContext().getResources().getString(R.string.form_download_progress,
                ...
                results.put(serverFormDetails, Collect.getInstance().getApplicationContext().getResources().getString(R.string.success));
            } catch (FormDownloadException e) {
                results.put(serverFormDetails, Collect.getInstance().getApplicationContext().getResources().getString(R.string.failure));
