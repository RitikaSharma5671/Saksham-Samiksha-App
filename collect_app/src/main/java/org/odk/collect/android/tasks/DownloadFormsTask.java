        ...
        for (ServerFormDetails serverFormDetails : values[0]) {
            try {
                ...
                formDownloader.downloadForm(serverFormDetails, count -> {
                    String message = Collect1.getInstance().getAppContext().getResources().getString(R.string.form_download_progress,
                ...
                results.put(serverFormDetails, Collect1.getInstance().getAppContext().getResources().getString(R.string.success));
            } catch (FormDownloadException e) {
                results.put(serverFormDetails, Collect1.getInstance().getAppContext().getResources().getString(R.string.failure));
