...
public class FormLoaderTask extends AsyncTask<String, String, FormLoaderTask.FECWrapper> {
    ...
    protected FECWrapper doInBackground(String... path) {
        ...
        try {
            ...
            Timber.e(e);
            errorMsg = TranslationHandler.getString(Collect1.getInstance().getAppContext(), R.string.too_complex_form);
    ...
    private FormDef createFormDefFromCacheOrXml(String formPath, File formXml) {
        publishProgress(
                TranslationHandler.getString(Collect1.getInstance().getAppContext(), R.string.survey_loading_reading_form_message));
        ...
        if (instancePath != null) {
            ...
            if (instanceXml.exists()) {
                ...
                try {
                    ...
                    publishProgress(TranslationHandler.getString(Collect1.getInstance().getAppContext(), R.string.survey_loading_reading_data_message));
