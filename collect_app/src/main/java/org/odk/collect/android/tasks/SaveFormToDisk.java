...
public class SaveFormToDisk {
    ...
    public SaveToDiskResult saveForm(FormSaver.ProgressListener progressListener) {
        ...
        progressListener.onProgressUpdate(TranslationHandler.getString(Collect.getInstance().getApplicationContext(), R.string.survey_saving_validating_message));
    ...
    private void updateInstanceDatabase(boolean incomplete, boolean canEditAfterCompleted) {
        ...
        if (Collect.getInstance().getApplication().getContentResolver().getType(uri).equals(
            ...
            int updated = Collect.getInstance().getApplication().getContentResolver().update(uri, values, null, null);
            if (updated > 1) {
        ...
        } else if (Collect.getInstance().getApplication().getContentResolver().getType(uri).equals(
            ...
            if (updated > 1) {
                ...
                try (Cursor c = Collect.getInstance().getApplication().getContentResolver().query(uri, null, null, null, null)) {
    ...
    private void exportData(boolean markCompleted, FormSaver.ProgressListener progressListener) throws IOException, EncryptionException {
        ...
        progressListener.onProgressUpdate(TranslationHandler.getString(Collect.getInstance().getApplicationContext(), R.string.survey_saving_collecting_message));
        ...
        progressListener.onProgressUpdate(TranslationHandler.getString(Collect.getInstance().getApplicationContext(), R.string.survey_saving_saving_message));
        ...
        if (markCompleted) {
            ...
            progressListener.onProgressUpdate(
                    TranslationHandler.getString(Collect.getInstance().getApplicationContext(), R.string.survey_saving_finalizing_message));
            ...
            if (formInfo != null) {
                ...
                progressListener.onProgressUpdate(
                        TranslationHandler.getString(Collect.getInstance().getApplicationContext(), R.string.survey_saving_encrypting_message));
    ...
    private static String getGeometryXpathForInstance(Uri uri) {
        try (Cursor instanceCursor = Collect.getInstance().getApplication().getContentResolver().query(
