    ...
    public String synchronizeAndReturnError() {
        ...
        try {
            ...
            if (errors.length() != 0) {
                ...
                Timber.d(TranslationHandler.getString(Collect.getInstance().getApplicationContext(), R.string.finished_disk_scan));
            }
    ...
    private ContentValues buildContentValues(File formDefFile) throws IllegalArgumentException {
        ...
        if (title != null) {
            ...
            throw new IllegalArgumentException(
                    TranslationHandler.getString(Collect.getInstance().getApplicationContext(), R.string.xform_parse_error,
