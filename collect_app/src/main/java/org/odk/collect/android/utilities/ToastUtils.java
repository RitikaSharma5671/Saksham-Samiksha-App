...
public class ToastUtils {
    ...
    private static void showToast(String message, int duration) {
        Toast.makeText(Collect.getInstance().getApplicationContext(), message, duration).show();
    }

    private static void showToast(int messageResource, int duration) {
        Toast.makeText(Collect.getInstance().getApplicationContext(), TranslationHandler.getString(Collect.getInstance().getApplicationContext(), messageResource), duration).show();
    }

    public static void showShortToastInMiddle(int messageResource) {
        showToastInMiddle(TranslationHandler.getString(Collect.getInstance().getApplicationContext(), messageResource), Toast.LENGTH_SHORT);
    }
    ...
    public static void showLongToastInMiddle(int messageResource) {
        showToastInMiddle(TranslationHandler.getString(Collect.getInstance().getApplicationContext(), messageResource), Toast.LENGTH_LONG);
    }

    private static void showToastInMiddle(String message, int duration) {
        Toast toast = Toast.makeText(Collect.getInstance().getApplicationContext(), message, duration);
        try {
