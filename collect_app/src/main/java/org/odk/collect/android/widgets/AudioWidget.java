...
public class AudioWidget extends QuestionWidget implements FileWidget, WidgetDataReceiver {
    ...
    public AudioWidget(Context context, QuestionDetails questionDetails, QuestionMediaManager questionMediaManager,  RecordingRequester recordingRequester, AudioFileRequester audioFileRequester) {
