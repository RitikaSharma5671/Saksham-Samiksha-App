...
public class ExternalAppRecordingRequester implements RecordingRequester {
    ...
    public ExternalAppRecordingRequester(Activity activity, ActivityAvailability activityAvailability, WaitingForDataRegistry waitingForDataRegistry, PermissionUtils permissionUtils, FormEntryViewModel formEntryViewModel,LifecycleOwner lifecycleOwner) {
