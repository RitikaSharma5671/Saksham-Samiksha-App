...
public class InvalidConfigurationException extends RuntimeException {
    ...
    private void assignDetailedMessage() {
        if (clazz.getCanonicalName().equals(ProfileSectionDriver.class.getCanonicalName())) {
            detailedMessage = ProfileSectionDriver.class.getSimpleName() + " is not initialized. You need to call the init method before used any functions from this class.";
