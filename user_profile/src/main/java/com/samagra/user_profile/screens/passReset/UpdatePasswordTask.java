...
public class UpdatePasswordTask extends AsyncTask<String, Void, String> {
    ...
    UpdatePasswordTask(ActionListener listener, String updatePasswordURL, String applicationID){
    ...
    protected String doInBackground(String[] strings) {
        String serverURL = updatePasswordURL;
        ...
        try {
            ...
            requestJson.put("applicationId", applicationID);
