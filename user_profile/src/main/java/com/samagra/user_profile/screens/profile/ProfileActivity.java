...
import com.samagra.user_profile.screens.passReset.OTPActivity;
import com.samagra.user_profile.screens.passReset.SendOTPTask;
...
public class ProfileActivity extends BaseActivity implements ProfileContract.View {
    ...
    private ArrayList<ProfileElementViewHolders.ProfileElementHolder> dynamicHolders;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null && getIntent().getParcelableArrayListExtra("config") != null) {
            ...
            sendOTPUrl = getIntent().getStringExtra("sendOTPUrl");
            updatePasswordURL = getIntent().getStringExtra("updatePasswordURL");
        ...
        for (UserProfileElement profileElement : userProfileElements) {
            ...
            switch (profileElement.getProfileElementContentType()) {
                ...
                case PHONE_NUMBER:
                    ...
                    ProfileElementViewHolders.NumberTextViewHolder numberTextViewHolder = new ProfileElementViewHolders.NumberTextViewHolder(numberTextView, profileElement, profilePresenter.getContentValueFromKey(profileElement.getContent()));
                ...
                case SPINNER:
                    ...
                    ProfileElementViewHolders.SpinnerTextViewHolder spinnerTextViewHolder = new ProfileElementViewHolders.SpinnerTextViewHolder(spinnerView, profileElement, profilePresenter.getContentValueFromKey(profileElement.getContent()));
    ...
    public void onProfileEditButtonClicked(View v) {
        ...
        if (profilePresenter.isNetworkConnected()) {
            ...
            for (ProfileElementViewHolders.ProfileElementHolder elementHolder : dynamicHolders) {
    ...
    public void onEditPasswordButtonClicked(View v) {
        ...
        if(profilePresenter.isNetworkConnected()){
            String phoneNumber= profilePresenter.getContentValueFromKey(dynamicHolders.get(0).getUserProfileElement().getContent());
            new SendOTPTask(new ActionListener() {
                @Override
                public void onSuccess() {
                    hideLoading();
                    Intent otpIntent = new Intent(ProfileActivity.this, OTPActivity.class);
                    otpIntent.putExtra("updatePasswordURL", updatePasswordURL);
                    otpIntent.putExtra("applicationID", applicationID);
            ...
            }, sendOTPUrl).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, phoneNumber);
        }else{
            hideLoading();
